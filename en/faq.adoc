...
Unfortunately, no. The image is based on the Microsoft Windows operating system which can't be legally copied in this way. The other tools can be downloaded from link:https://kib-files.fit.cvut.cz/mi-rev/nastroje/[here] or their homepages, but we are not allowed to distribute Windows.
