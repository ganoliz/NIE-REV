...
Pokud by se cvičení konat nemohlo, chovejte se k němu prosím, jako kdyby odpadlo. Zájemci o analýzu vyšších jazyků mohou využít link:https://kib-files.fit.cvut.cz/mi-rev/recordings/2020/en/tutorial_12.mp4[nahrávky], kterou jsme vytvořili předloni pro anglickou verzi předmětu. Abyste však nebyli o cvičení úplně ochuzeni, budu dostupný jak online tak fyzicky v laboratoři, ale není plánovaný žádný konkrétní program -- cvičení bude ryze konzultační.
