...
Toto je nepovinné heslo, které není nezbytné pro získání plného počtu bodů z předmětu. Je určeno jako bonus pro zájemce, případně jako částečná kompenzace za body, které jste mnohli získat v rámci úlohy xref:keygen.adoc[Keygen], pokud byste se rozhodli tuto úlohu vynechat.
