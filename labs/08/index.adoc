...
Programy, se kterými budeme pracovat, jsou dostupné zde: {{:labs:08:cv5.zip|}}. Pro jejich spuštění budete potřebovat 32bitovou verzi [[https://www.microsoft.com/en-us/download/details.aspx?id=5555|Visual Studio 2010 Runtime]].
