...
* link:https://kib-files.fit.cvut.cz/mi-rev/recordings/2021/NI-cviceni_01_102.mp4[Záznam cvičení]
...
[TIP]
====
Stručný popis Intelovského assembleru si můžete přečíst https://www.cs.virginia.edu/~evans/cs216/guides/x86.html[zde] (link:{imagesdir}/x86.htm[lokální kopie]), poněkud odlišněji zaměřený a novější, ale určený pro 64bitové systémy, které nepoužíváme, a navíc v jiné notaci, popis Toma Doeppnera https://cs.brown.edu/courses/cs033/docs/guides/x64_cheatsheet.pdf[zde] (link:{imagesdir}/x64_cheatsheet.pdf[lokální kopie]). Referenčním zdrojem informací je pochopitelně https://www.intel.com/content/dam/www/public/us/en/documents/manuals/64-ia-32-architectures-software-developer-instruction-set-reference-manual-325383.pdf[Software Developer's Manual] od Intelu.
====
